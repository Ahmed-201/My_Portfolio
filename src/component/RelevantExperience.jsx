...
<div className=" text-light py-16">
  <div className="container mx-auto flex flex-col items-end px-4">
    ...
    <div className="w-full mb-12">
      <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold leading-[0.4]">
        RELEVANT
      </h1>
    ...
    <div>
      ...
      <div className="flex flex-col gap-4 mb-5">
        <div className="">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold">Kdys LAB</h2>
        </div>
        ...
        <div>
          <p className="text-[#929292] text-base sm:text-lg">
            Built frontend UI and handled API integrations for dynamic, data-driven applications.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 mt-5">
        <div className="">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold">Universal Motors ltd.</h2>
        </div>
        <div className="flex flex-col sm:flex-row justify-between text-lg sm:text-xl font-semibold gap-2">
          <h4>FRONTEND DEVELOPER</h4>
        ...
        <div>
          <p className="text-[#929292] text-base sm:text-lg">
            Next.js & TypeScript development, API integration, and bug fixing for the official website.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-8">
        <button
          type="button"
          className="rounded-full border-2 border-light px-6 py-2 text-light hover:bg-white !hover:text-red transition"
        >
          VIEW WORK
        </button>
        <button
          type="button"
          className="rounded-full border-2 border-light px-6 py-2 text-light hover:bg-light hover:text-dark transition"
          onClick={handleViewResume}
        >
          RESUME
        </button>
